                    ...
                    <div class="mockup-body">
                        ...
                        <slot name="mockup">
                            ...
                            <div v-else class="mockup-placeholder">
                                ...
                                <div class="ph-chart">ປະຢັດ​ເວລາ, ສະດວກ ໂດຍລູກຄ້າບໍ່ຕ້ອງລໍຖ້າການໃຊ້ບໍລິການ ຫຼື
                                    ຊອກຫາຕູ້​ເອທີ​ເອັມຂອງ ທະນາຄານຜູ້ອອກບັດ
                                    ກໍ່ສາມາດກວດຍອດເງິນຜ່ານຕູ້​ເອທີ​ເອັມຂອງບັນດາທະນາຄານທຸກລະກິດທີ່ເຊື່ອມຕໍ່ກັບລະບົບແລັບ.
                                </div>

                                <div class="ph-title">ດ້ານທະນາຄານສະມາຊິກ</div>

                                <div class="ph-chart">ປະຢັດ​ເວລາ, ສະດວກ ໂດຍລູກຄ້າບໍ່ຕ້ອງລໍຖ້າການໃຊ້ບໍລິການ ຫຼື
                                    ຊອກຫາຕູ້​ເອທີ​ເອັມຂອງ ທະນາຄານຜູ້ອອບັດ
                                    ກໍ່ສາມາດກວດຍອດເງິນຜ່ານຕູ້​ເອທີ​ເອັມຂອງບັນດາທະນາຄານທຸກລະກິດທີ່ເຊື່ອມຕໍ່ກັບລະບົບແລັບ.
                                </div>
                            </div>
                        </slot>
...
let strokeTween, floatTween, glowTween1, glowTween2, pulseTween, enterTl;
let ro;
...
function setupStroke() {
    ...
    const dash = Math.max(140, length * 0.2); // highlight segment
