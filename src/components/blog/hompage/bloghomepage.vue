  ...
  <div class="card" @click="goToBlogDetail(item.id)">
    <div class="card-inner">
      ...
      <div class="card-info">
        ...
        <!-- stop propagation so click is only on button if you want -->
        <button
          class="card-read-btn"
          @click.stop="goToBlogDetail(item.id)"
        >
...
const images = [
  ...
  },
  {
    ...
    alt: "My photo 3",
    title:
      "ຄະນະສະພາບໍລິຫານຂອງ ບໍລິສັດ ຢູນຽນເພ ສປ.ຈີນ (UPI) ເຂົ້າພົບປະຢ້ຽມຢາມ. ",
    date: "06 ພະຈິກ 2025",
    description: ""
  },
  {
